#!/bin/sh
#
# create-puremail-l10n-tarball.sh
...
#    https://download-origin.cdn.mozilla.net/pub/puremail
#
...
MOZILLA_CDN_BASE="download-origin.cdn.mozilla.net/pub/puremail/"
...
Examples:
  ${0##*/} -d 45.0
    ...
    Download version '45.0' of the locales for puremail from Mozilla and
    creates a file 'puremail_45.0.orig-puremail-l10n.tar.xz'.


  ${0##*/} -de 45.0b1 45.0~b1

    Download the beta version '45.0b1' of the locales for puremail from
    Mozilla and create a file 'puremail_45.0~b1.orig-puremail-l10n.tar.xz'.


  ${0##*/} -vde 45.0b1 45.0~b1

    Same as above, download the beta version '45.0b1' of the locales for
    puremail from Mozilla and create a file
    'puremail_45.0~b1.orig-puremail-l10n.tar.xz'.
