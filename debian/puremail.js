// This is the Debian specific preferences file for Mozilla puremail
// You can make any change in here, it is the purpose of this file.
// You can, with this file and all files present in the directory
//
//      /etc/puremail/pref directory
//
// override any preference that is present in the directory
//
//      /usr/lib/puremail/defaults/pref
//
// While your changes will be kept on upgrade if you modify files in
// /etc/puremail/pref, please note that they won't be kept if you
// do them in /usr/lib/puremail/defaults/pref.
